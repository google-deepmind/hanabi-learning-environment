...
class HanabiEnv(Environment):
    ...
    def _extract_dict_from_backend(self, player_id, observation):
        ...
        """
        obs_dict = {"current_player": self.state.cur_player(), "current_player_offset": observation.cur_player_offset(),
                    "life_tokens": observation.life_tokens(), "information_tokens": observation.information_tokens(),
                    "num_players": observation.num_players(), "deck_size": observation.deck_size(), "fireworks": {}}
